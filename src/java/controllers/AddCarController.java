...
public class AddCarController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int carID = Integer.parseInt(request.getParameter("CarIDUpdate"));
            String carName = request.getParameter("CarNameUpdate");
            String manufacturer = request.getParameter("ManufacturerUpdate");
            double price = Double.parseDouble(request.getParameter("PriceUpdate"));
            int releasedYear = Integer.parseInt(request.getParameter("ReleasedYearUpdate"));
